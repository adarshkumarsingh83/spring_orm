...
<c:url var="addUrl" value="/adarsh/main/record/add"/>
<table style="border: 1px solid; width: 100%; text-align:center">
    ...
    <c:forEach items="${persons}" var="person">
        <c:url var="editUrl" value="/adarsh/main/record/edit?id=${person.id}"/>
        <c:url var="deleteUrl" value="/adarsh/main/record/delete?id=${person.id}"/>
        ...
        <c:if test="${!empty person.creditCards}">
            <c:forEach items="${person.creditCards}" var="creditCard">
                <tr>
                    ...
                    <c:url var="addCcUrl" value="/adarsh/main/creditcard/add?id=${person.id}"/>
                    <c:url var="editCcUrl" value="/adarsh/main/creditcard/edit?pid=${person.id}&cid=${creditCard.id}"/>
                    <c:url var="deleteCcUrl" value="/adarsh/main/creditcard/delete?id=${creditCard.id}"/>
